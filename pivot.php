...
<body>
    ...
    <div id="contentContainer">
      <div id="nonmap">
        ...
        <a name="airport"></a>
        <h2>Analytical Operation - Pivot</h2>
    <?php
        ...
        try {
            ...
            print "<h3>Pivot Operation</h3>\n";

            print "<h1>Before Pivot</h1>\n";
            ...
            $query2 = "Select cubeview1.Name, Case when Quarter = 'Q1' then Revenue_Generated end as Q1, Case when Quarter = 'Q3' then Revenue_Generated end as Q3, Case when Quarter = 'Q4' then Revenue_Generated end as Q4 From cubeview1";
